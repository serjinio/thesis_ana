...
void rectang_tgt_cut() {
  ...
  TCut rect_target_cut{
    "tgt_up_xpos > -2 && tgt_up_xpos < 2 && tgt_up_ypos > -2 && tgt_up_ypos < 2"};
  ...
  TFile hist_out("out/rectang_tgt_cut.root", "RECREATE");
  TCanvas c1("c1");
  ...
  c1.Divide(2);
  c1.cd(1);
  hdraw(chain_up, "tgt_hit", "tgt_up_ypos:tgt_up_xpos",
        "(200,-40,40,200,-40,40)",
        "triggers[5]==1",
  ...
  c1.cd(2);
  hdraw(chain_up, "tgt_hit_cut", "tgt_up_ypos:tgt_up_xpos",
        "(200,-40,40,200,-40,40)",
        "triggers[5]==1" && target_cut,
        "Target hit position - upstream extrapolation, pol. up, cut",
        "X hit position [mm]",
        "Y hit position [mm]", "colz");
  c1.Print("out/rectang_tgt_cut.pdf(", "pdf");
  ...
  hdraw(chain_up, "polar_up_cut", "p_theta*57.3:s1dc_theta*57.3",
        ...
        "Polar angle correlation - pol. up runs, rectnag. tgt cut",
        "Fragment #theta angle [lab. deg.]",
        "Proton #theta angle [lab. deg.]", "colz");
  c1.Print("out/rectang_tgt_cut.pdf)", "pdf");
